...
CORS(app, resources={r"/api/*": {"origins": ["http://localhost:3000", "https://gscf.onrender.com", "https://gscb-giaw.onrender.com", "https://gscb-7ti0.onrender.com"]}}, supports_credentials=True)
...
def api_predict():
    try:
        ...
        df_new = pd.read_csv('FinalCookieSales.csv')
